...
async def knowledge_base_chat(query: str = Body(..., description="用户输入", examples=["你好"]),
                            ...
                            score_threshold: float = Body(0.53, description="知识库匹配相关度阈值，取值范围在0-1之间，SCORE越小，相关度越高，取到1相当于不筛选，建议设置在0.5左右", ge=0, le=1),
    ...
    async def knowledge_base_chat_iterator(query: str,
        ...
        docs = search_docs(query, knowledge_base_name, top_k, score_threshold=score)
